...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-black","fx-listitems-drop","pagedim-black",["position-right"]],navbar:{title:'<img src="img/logo.svg" alt="Купальники для художественной гимнастики">'},offCanvas:{position:"right"}})});